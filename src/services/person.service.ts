...
class PersonService {
  ...
  public async getServicePerson(){
    ...
    person.map((b) =>{
        let obj: IPerson = {idperson: b.idperson, idrol: b.idrol, name: b.name, lastname:b.lastname,date_b:b.date_b,
          dni: b.dni,gender:b.gender,address:b.address, username:b.username, password:b.password, state: b.state, key:b.key };
        respuesta.push(obj);
    })
    return respuesta;
}
